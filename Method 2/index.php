...
<div class="content">
        ...
        <div class="content__feedback feedback" id="companies">
			...
			<?$APPLICATION->IncludeComponent("bitrix:news.list", "slide", Array(
...
<!--            <span class="gallery__item gallery__item-one gallery_active"></span>-->
<!--            <span class="gallery__item gallery__item-two"></span>-->
<!--            <span class="gallery__item gallery__item-tree"></span>-->
<!--        </div>-->
    </div>
